        ...
        if ("1".equals(mailMessageType)) {
            ...
            if (request != null || fu != null || !"".equals(oaaddress)) {
                ...
                if (GCONST.getMailReminderSet()) {
                    ...
                    loginPage = "login/LoginMail.jsp";   //邮件提醒的登录中转页面
                }
            ...
            if (src.equals("submit") || src.equals("intervenor")) {
                ...
                //审批 例如：审批提醒：有新的工作需要你审批XXX费用报销单
                if (!approvalmail.equals("")) {
                    ...
                    String title_beginS = Util.null2String(super.getPropValue("MailMessage", "mailMSG.approve.title.begin"));//审批提醒：您有新的工作流需要审批
                    String title_endS = Util.null2String(super.getPropValue("MailMessage", "mailMSG.approve.title.end"));
                    String content_beginS = Util.null2String(super.getPropValue("MailMessage", "mailMSG.approve.content.begin"));//审批提醒：您有新的工作流需要审批
