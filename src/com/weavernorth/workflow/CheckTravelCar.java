...
public class CheckTravelCar extends BaseAction {
    ...
    public String execute(RequestInfo request) {
        ...
        if (RsSelect.first()) {
            ...
            String strCheckStartSql = "select * from " + strTablename + " where requestid<>" + requestid + " and Name_Number="
					+ strHrmId + " and '" + strStartTime + "' between  Travel_Date+' '+cnvb and Travel_End_Date+' '+end_time";
            ...
            String strCheckEndSql = "select * from " + strTablename + " where requestid<>" + requestid + " and Name_Number="
					+ strHrmId + " and '" + strEndTime + "' between  Travel_Date+' '+cnvb and Travel_End_Date+' '+end_time";
        ...
        String strCheckStartBackSql = "select * from " + strTablename + " where requestid<>" + requestid + " and Name_Number="
				+ strHrmId + " and Travel_Date+' '+cnvb between '" + strStartTime + "'  and '" + strEndTime + "'";
        ...
        String strCheckEndBackSql = "select * from " + strTablename + " where requestid<>" + requestid + " and Name_Number="
				+ strHrmId + " and Travel_End_Date+' '+end_time between '" + strStartTime + "'  and '" + strEndTime + "'";
