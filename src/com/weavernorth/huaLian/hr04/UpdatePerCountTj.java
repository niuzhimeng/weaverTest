...
public class UpdatePerCountTj extends BaseAction {
    ...
    public String execute(RequestInfo requestInfo) {
        baseBean.writeLog("HR-04 人力需求申请流程  - 提交 start" + TimeUtil.getCurrentTimeString());
        try {
            ...
            baseBean.writeLog("HR-04 人力需求申请流程  - 提交 end" + TimeUtil.getCurrentTimeString());
        } catch (Exception e) {
            baseBean.writeLog("HR-04 人力需求申请流程  - 提交 Exception: " + e);
