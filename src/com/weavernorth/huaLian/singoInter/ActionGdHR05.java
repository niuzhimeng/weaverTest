 ...
 * HR - 05 - 入职审批流程  - 归档
 */
public class ActionGdHR05 extends BaseAction {

    private BaseBean baseBean = new BaseBean();

    @Override
    public String execute(RequestInfo requestInfo) {
        baseBean.writeLog("HR - 05 - 入职审批流程 - 归档start " + TimeUtil.getCurrentTimeString());
        try {
            ...
            baseBean.writeLog("HR - 05 - 入职审批流程 - 归档 end " + TimeUtil.getCurrentTimeString());
        } catch (Exception e) {
            baseBean.writeLog("HR - 05 - 入职审批流程 - 归档Exception: " + TimeUtil.getCurrentTimeString() + e);
