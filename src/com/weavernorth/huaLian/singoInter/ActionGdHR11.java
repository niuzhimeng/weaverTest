 ...
 * HR 11 - 离职流程 - 归档
 */
public class ActionGdHR11 extends BaseAction {

    private BaseBean baseBean = new BaseBean();

    @Override
    public String execute(RequestInfo requestInfo) {
        baseBean.writeLog("HR 11 - 离职流程 - 归档start " + TimeUtil.getCurrentTimeString());
        try {
            ...
            baseBean.writeLog("HR 11 - 离职流程 - 归档Exception: " + TimeUtil.getCurrentTimeString() + e);
