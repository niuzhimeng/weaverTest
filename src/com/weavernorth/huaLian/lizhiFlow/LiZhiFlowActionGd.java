package com.weavernorth.huaLian.lizhiFlow;
 ...
 * 11 - 离职流程 - 归档
 */
public class LiZhiFlowActionGd extends BaseAction {

    private BaseBean baseBean = new BaseBean();

    @Override
    public String execute(RequestInfo requestInfo) {
        baseBean.writeLog("11 - 离职流程 - 归档start " + TimeUtil.getCurrentTimeString());
        ...
        try {
            ...
            baseBean.writeLog("11 - 离职流程 - 归档Exception: " + e);
