 ...
 * 管理费用插入系统预算
 */
public class UpdateBudgetGl extends BaseAction {
    ...
    public String execute(RequestInfo requestInfo) {
        baseBean.writeLog("更新预算表 - 管理费用 Start --------- " + TimeUtil.getCurrentTimeString());
        ...
        try {
            ...
            baseBean.writeLog("更新管理费用明细表 异常： " + e);
        }
        baseBean.writeLog("更新管理费用明细 End --------- " + TimeUtil.getCurrentTimeString());
        return "1";
    }
