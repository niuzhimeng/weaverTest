 ...
 * 研发费用插入系统预算
 */
public class UpdateBudgetYf extends BaseAction {
    ...
    public String execute(RequestInfo requestInfo) {
        baseBean.writeLog("更新预算表 - 研发费用 Start --------- " + TimeUtil.getCurrentTimeString());
        ...
        try {
            ...
            baseBean.writeLog("更新研发费用明细表 异常： " + e);
        }
        baseBean.writeLog("更新研发费用明细 End --------- " + TimeUtil.getCurrentTimeString());
        return "1";
    }
