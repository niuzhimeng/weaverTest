package com.weavernorth.saiwen.action.xsbj;
 ...
 * 销售报价
 */
public class SalesPrice extends BaseAction {
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        this.writeLog("销售报价 Start requestid --- " + requestId + "  operatetype --- " + operateType + "   fromTable --- " + tableName);
        try {
            // 查询主表
            ...
            this.writeLog("销售报价 End ===============");
        } catch (Exception e) {
            this.writeLog("销售报价 异常： " + e);
            requestInfo.getRequestManager().setMessageid("110000");
            requestInfo.getRequestManager().setMessagecontent("销售报价 异常： " + e);
            return "0";
        }
