 ...
 * 二公司流程编号修改
 */
public class Company2 extends BaseAction {
    @Override
    public String execute(RequestInfo requestInfo) {
        this.writeLog("-----------------------二公司流程编号修改执行----------------------------------" + TimeUtil.getCurrentTimeString());
        ...
        if ("1".equals(wjlx)) {
            if ("3".equals(wjzlx)) {
                ...
                if ("办".equals(bmdz)) {
                    wh = whstr[0] + "党委专纪" + bmdz + whstr[1].substring(1);
                } else {
                    //组织人事部  -党委文件-专题会-会议纪要
                    wh = whstr[0] + "党委纪" + bmdz + whstr[1].substring(1);
                }
            }
