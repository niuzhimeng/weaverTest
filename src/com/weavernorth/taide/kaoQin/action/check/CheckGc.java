 ...
 * 考勤补贴流程提交校验
 */
public class CheckGc extends BaseAction {
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        try {
            ...
            if (ksDate.before(bzDate)) {
                ...
                requestInfo.getRequestManager().setMessagecontent("公出开始日期需大于等于" + bzDateStr);
                return "0";

            } else if (jsDate.before(bzDate)) {
                requestInfo.getRequestManager().setMessageid("110000");
                requestInfo.getRequestManager().setMessagecontent("公出结束日期需大于等于" + bzDateStr);
                return "0";
            }
        } catch (Exception e) {
