    ...
    public String execute(RequestInfo requestInfo) {
        ...
        try {
            ...
            if (ksDate.before(bzDate)) {
                ...
                requestInfo.getRequestManager().setMessagecontent("加班开始日期需大于等于" + bzDateStr);
                return "0";

            } else if (jsDate.before(bzDate)) {
                requestInfo.getRequestManager().setMessageid("110000");
                requestInfo.getRequestManager().setMessagecontent("加班结束日期需大于等于" + bzDateStr);
                return "0";
            }
        } catch (Exception e) {
