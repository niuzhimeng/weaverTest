...
public class PushKqWorkFlowUtil {
    ...
    public static DT_HR0002_OUTRet_Msg[] execute(DT_HR0002_IN dtHr0002In) {
        baseBean.writeLog("PushKqWorkFlowUtil 执行开始=============== " + TimeUtil.getCurrentTimeString());
        String userName = "";
        String passWord = "";
        RecordSet recordSet = new RecordSet();
        DT_HR0002_OUTRet_Msg[] dt_hr0002_outRet_msgs = new DT_HR0002_OUTRet_Msg[0];
        try {
