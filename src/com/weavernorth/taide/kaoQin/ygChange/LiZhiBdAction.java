 ...
 * 员工离职 被动 OA -> SAP
 */
public class LiZhiBdAction extends BaseAction {
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        this.writeLog("员工离职 被动 OA -> SAP start requestid --- " + requestId + "  operatetype --- " + operatetype + "   fromTable --- " + tableName);
        if (operatetype.equals("submit")) {
            try {
                ...
                String qrlzrq = recordSet.getString("qrlzrq");// 辞退日期
                ...
                this.writeLog("员工离职 被动 OA -> SAP end ===================");
            } catch (Exception e) {
                this.writeLog("员工离职 被动 OA -> SAP 异常： " + e);
                requestInfo.getRequestManager().setMessageid("110000");
                requestInfo.getRequestManager().setMessagecontent("员工离职 被动 OA -> SAP 异常： " + e);
                return "0";
            }
        }
        return "1";
