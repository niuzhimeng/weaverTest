...
public class ZhuanZhengAction extends BaseAction {
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        this.writeLog("01-员工转正 OA -> SAP start requestid --- " + requestId + "  operatetype --- " + operatetype + "   fromTable --- " + tableName);
        if (operatetype.equals("submit")) {
            try {
                ...
                this.writeLog("01-员工转正 OA -> SAP end ===================");
            } catch (Exception e) {
                this.writeLog("01-员工转正 OA -> SAP 异常： " + e);
                requestInfo.getRequestManager().setMessageid("110000");
                requestInfo.getRequestManager().setMessagecontent("01-员工转正 OA -> SAP 异常： " + e);
                return "0";
            }
        }
        return "1";
