...
public class DT_HRI011_INDATA  implements java.io.Serializable {
    private com.weavernorth.taide.kaoQin.jbxx.myWeb.DT_HRI011_INDATAITEMS ITEMS;

    public DT_HRI011_INDATA() {
    }

    public DT_HRI011_INDATA(
           com.weavernorth.taide.kaoQin.jbxx.myWeb.DT_HRI011_INDATAITEMS ITEMS) {
           this.ITEMS = ITEMS;
    }
     ...
     * @return ITEMS
     */
    public com.weavernorth.taide.kaoQin.jbxx.myWeb.DT_HRI011_INDATAITEMS getITEMS() {
        return ITEMS;
    }
     ...
     * @param ITEMS
     */
    public void setITEMS(com.weavernorth.taide.kaoQin.jbxx.myWeb.DT_HRI011_INDATAITEMS ITEMS) {
        this.ITEMS = ITEMS;
    }
