package com.weavernorth.taide.kaoQin.qingGou;

import com.google.gson.Gson;
import com.weaver.general.TimeUtil;
import com.weavernorth.taide.kaoQin.qingGou.myWeb.DT_MMI001_IN;
import com.weavernorth.taide.kaoQin.qingGou.myWeb.DT_MMI001_ININPUT;
import com.weavernorth.taide.kaoQin.qingGou.myWeb.DT_MMI001_OUTOUTPUT;
import com.weavernorth.taide.kaoQin.qingGou.myWeb.QingGouUtil;
 ...
 * 非生产类 action
 */
public class FeiShengChanAction extends BaseAction {
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        this.writeLog("非生产物料请购单 action 执行 " + TimeUtil.getCurrentTimeString() + " requestid: " + requestId + " tableName: " + tableName);
        ...
        if (operatetype.equals("submit")) {
            try {
                ...
                String sql = "select d.* from " + tableName + "_dt1 d left join " + tableName + " m on m.id = d.mainid where m.requestId = '" + requestId + "' and sapwl = 0";
                ...
                while (detailSet.next()) {
                    ...
                    String wlbm = detailSet.getString("wlbm");// 物料编码
                    ...
                    String qgrq = detailSet.getString("gmrq"); // 需求日期
                    ...
                    dt_mmi001_ininput.setMATNR(wlbm); // 物料编码
                    dt_mmi001_ininput.setTXZ01(""); // 描述文本
