...
import com.weavernorth.taide.kaoQin500.action.myWeb.*;
 ...
 * 02-总部员工请假申请
 */
public class Qjsq02 extends BaseAction {
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        this.writeLog("02-总部员工请假申请 start requestid --- " + requestId + "  operatetype --- " + operatetype + "   fromTable --- " + tableName);
        if (operatetype.equals("submit")) {
            try {
                ...
                if (recordSet.next()) {
                    ...
                    this.writeLog("流程编号=============： " + bh);
                    // 拼接对象
                    DT_HR0002_ININPUT dt_hr0002_ininput = new DT_HR0002_ININPUT();
                    dt_hr0002_ininput.setTYPE("2001"); // 设置接口类型 '2002'."人事公出；'2001'."人事请假；'2005'."人事加班； '2010'."补贴次数
                    ...
                    dt_hr0002_ininputpt2002.setAWART(recordSet.getString("qjdm")); // 请假sap代码
