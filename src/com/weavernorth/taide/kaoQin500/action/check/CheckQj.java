        ...
        try {
            ...
            if (Integer.parseInt(currentDate) >= Integer.parseInt(jzDate)) {
                ...
                if (ksDate.before(bzDate)) {
                    ...
                    requestInfo.getRequestManager().setMessagecontent("请假开始日期需大于等于当月 " + bzDateJian1 + " 日");
                    return "0";
                }
            } else {
                ...
                if (ksDate.before(calendar.getTime())) {
                    requestInfo.getRequestManager().setMessageid("110000");
                    requestInfo.getRequestManager().setMessagecontent("请假开始日期需大于等于上月 " + bzDateJian1 + " 日");
                    return "0";
                }
            }
        } catch (Exception e) {
