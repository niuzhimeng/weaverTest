...
public class DT_MMI002_ININPUTHEADER  implements java.io.Serializable {
    ...
    private DT_MMI002_ININPUTHEADERITEM[] ITEM;
    ...
    public DT_MMI002_ININPUTHEADER(
           ...
           String WEMPF,
           String REMARK1,
           DT_MMI002_ININPUTHEADERITEM[] ITEM) {
           this.WERKS = WERKS;
           this.BWART = BWART;
           this.KOSTL = KOSTL;
           this.AUFNR = AUFNR;
     ...
     * @return ITEM
     */
    public DT_MMI002_ININPUTHEADERITEM[] getITEM() {
        return ITEM;
    }
     ...
     * @param ITEM
     */
    public void setITEM(DT_MMI002_ININPUTHEADERITEM[] ITEM) {
        this.ITEM = ITEM;
    }

    public DT_MMI002_ININPUTHEADERITEM getITEM(int i) {
        return this.ITEM[i];
    }

    public void setITEM(int i, DT_MMI002_ININPUTHEADERITEM _value) {
        this.ITEM[i] = _value;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getITEM() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getITEM(), i);
                if (obj != null &&
