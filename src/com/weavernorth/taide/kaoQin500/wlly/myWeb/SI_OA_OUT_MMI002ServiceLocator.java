...
public class SI_OA_OUT_MMI002ServiceLocator extends org.apache.axis.client.Service implements SI_OA_OUT_MMI002Service {
    ...
    public SI_OA_OUT_MMI002ServiceLocator(String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for HTTPS_Port
    private String HTTPS_Port_address = "https://poqas.tidepharm.com:50001/XISOAPAdapter/MessageServlet?senderParty=&senderService=BC_OA_CREATE_RESERVATION&receiverParty=&receiverService=&interface=SI_OA_OUT_MMI002&interfaceNamespace=http%3A%2F%2Ftidepharm.com%2FOA";
    ...
    public SI_OA_OUT_MMI002 getHTTPS_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            SI_OA_OUT_MMI002BindingStub _stub = new SI_OA_OUT_MMI002BindingStub(portAddress, this);
    ...
    private String HTTP_Port_address = "http://poqas.tidepharm.com:50000/XISOAPAdapter/MessageServlet?senderParty=&senderService=BC_OA_CREATE_RESERVATION&receiverParty=&receiverService=&interface=SI_OA_OUT_MMI002&interfaceNamespace=http%3A%2F%2Ftidepharm.com%2FOA";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (SI_OA_OUT_MMI002.class.isAssignableFrom(serviceEndpointInterface)) {
                SI_OA_OUT_MMI002BindingStub _stub = new SI_OA_OUT_MMI002BindingStub(new java.net.URL(HTTPS_Port_address), this);
                _stub.setPortName(getHTTPS_PortWSDDServiceName());
                return _stub;
            }
            if (SI_OA_OUT_MMI002.class.isAssignableFrom(serviceEndpointInterface)) {
                SI_OA_OUT_MMI002BindingStub _stub = new SI_OA_OUT_MMI002BindingStub(new java.net.URL(HTTP_Port_address), this);
                _stub.setPortName(getHTTP_PortWSDDServiceName());
                return _stub;
            }
        }
