 ...
 * 连锁业务招待报销
 */
public class YeWuBxLianSuo extends BaseAction {
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        this.writeLog("业务招待报销节点后操作执行------表名： " + tableName + " 请求id： " + requestId);
        ...
        perSet.execute("select workcode, lastname from hrmresource where id = '" + tbr + "'");
        if (perSet.next()) {
        ...
        while (detailSet.next()) {
            ...
            if (detailSet.getString("fyje") == null || "".equals(detailSet.getString("fyje").trim())) {
                continue;
            }
            //明细表字段
