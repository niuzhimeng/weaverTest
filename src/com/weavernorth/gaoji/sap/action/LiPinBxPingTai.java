 ...
 * 平台礼品费用报销
 */
public class LiPinBxPingTai extends BaseAction {
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        this.writeLog("礼品费用节点后操作执行------表名： " + tableName + " 请求id： " + requestId);
        ...
        while (detailSet.next()) {
            ...
            baoXiaoDetailVo.setZFYLX(detailSet.getString("ptfylxlp"));//费用类型
        ...
        baseBean.writeLog("礼品报销拼接的json：" + TimeUtil.getCurrentTimeString() + " ---------- " + sendJson);
        //本地存储
