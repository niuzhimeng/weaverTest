 ...
 * 连锁团建报销
 */
public class TuanJianBxLianSuo extends BaseAction {
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        this.writeLog("团建报销节点后操作执行------表名： " + tableName + " 请求id： " + requestId);
        ...
        while (detailSet.next()) {
            ...
            baoXiaoDetailVo.setZFYLX(detailSet.getString("xfylx"));//费用类型
            baoXiaoDetailVo.setZBX(detailSet.getString("bhsje"));//不含税金额
            baoXiaoDetailVo.setZSE(detailSet.getString("zzsse"));//税额
        ...
        baseBean.writeLog("团建报销拼接的json：" + TimeUtil.getCurrentTimeString() + " ---------- " + sendJson);
