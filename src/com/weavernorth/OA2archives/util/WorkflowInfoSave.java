 ...
 */
public class WorkflowInfoSave {

    public boolean SaveWorkflowInfo(RequestInfo request, String strftppath, String saveStatus, String uploadStatus, Integer pageNum) {
    ...
    public boolean checkRecord(String requestid, String exceltype) {
        ...
        if ("1".equals(exceltype) || "2".equals(exceltype) || "29".equals(exceltype) || "30".equals(exceltype)
                || "42".equals(exceltype) || "49".equals(exceltype)
        ) {
    ...
    private boolean InsertContractInfo(ArchivesBean bean) {
        ...
        if ("1".equals(typeid) || "2".equals(typeid) || "29".equals(typeid) || "30".equals(typeid)
                || "42".equals(typeid) || "49".equals(typeid)
        ) {
     ...
     */
    //TODO 增加获取对应的流程typeid的逻辑
    private boolean UpdateContractInfo(ArchivesBean bean) {
    ...
    public Integer getMaxc_inner_sequence(String type) {
        ...
        // DBN合同类流程
        else if ("42".equals(type) || "49".equals(type)) {
            sql = "select max(c_inner_sequence) maxid from wn_oa2emc_contract where typeid ='" + type + "'";
