 ...
 * 跨群组流程
 */
public class KuaQzWorkFlow extends BaseAction {
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        this.writeLog("跨群组流程 Start requestid=" + requestId + "  operatetype --- " + operateType + "   fromTable --- " + tableName);
        try {
            // 字段中文名map
            ...
            String mspjNew = Util.null2String(recordSet.getString("mspjb")).trim(); // 面试评价表-调入
            if (!"".equals(mspjOld)) {
            ...
            this.writeLog("跨群组流程 End ===============");
        } catch (Exception e) {
            this.writeLog("跨群组流程 异常： " + e);
            requestInfo.getRequestManager().setMessageid("110000");
            requestInfo.getRequestManager().setMessagecontent("跨群组流程 异常： " + e);
            return "0";
        }
